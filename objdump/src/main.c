/*
** main.c for main in /objdump/src/
**
** Made by Frederic ODDOU
** Login   <frederic.oddou@epitech.eu>
**
** Started on  Mon Feb 13 14:12:40 2017 Frederic ODDOU
** Last update Fri Feb 24 13:01:29 2017 Frederic ODDOU
*/
				  ...
				  t_flag	flags)
{
  ...
  while (i < ac)
	...
	error += exec_file_name(flags, av[i]);
      i++;
    }
  if (!file)
    error += exec_file_name(flags, "a.out");
  return (error);
}
