...
** Last update Fri Feb 24 12:21:15 2017 Frederic ODDOU
*/
...
static char		find_type_2(Elf32_Shdr	*shdr,
				    Elf32_Sym	*sym)
{
  char			c;
...
static char		find_type(Elf32_Ehdr	*ehdr,
				  Elf32_Shdr	*shdr,
				  Elf32_Sym	*sym)
{
  char			c;
